...
import { HIGHWAY_SCALE_X, HIGHWAY_SCALE_Y, RAIL_OFFSET, RAIL_ROTATION, RAIL_SCALE_X, RAIL_SCALE_Y } from "./plane";
...
export const LANE_TOUCH_AREA_GEOMETRY = new three.BoxGeometry(LANE_TOUCH_AREA_SCALE_X, LANE_TOUCH_AREA_SCALE_Y, LANE_TOUCH_AREA_SCALE_Z);
export const LANE_TOUCH_AREA_MATERIAL = new three.MeshBasicMaterial({ color: 0x111111 });
...
export const createLaneTouchArea = (column) => {
    const mesh = new three.Mesh(LANE_TOUCH_AREA_GEOMETRY, LANE_TOUCH_AREA_MATERIAL);
    mesh.position.set(
...
export const RAIL_TOUCH_AREA_GEOMETRY = new three.BoxGeometry(RAIL_TOUCH_AREA_SCALE_X, RAIL_TOUCH_AREA_SCALE_Y, RAIL_TOUCH_AREA_SCALE_Z);
export const RAIL_TOUCH_AREA_MATERIAL = new three.MeshBasicMaterial({ color: 0x111111 });
...
export const createRailTouchArea = (column) => {
    const mesh = new three.Mesh(RAIL_TOUCH_AREA_GEOMETRY, RAIL_TOUCH_AREA_MATERIAL);
    mesh.rotation.set(
        0.0,
        0.0,
        RAIL_ROTATION * column,
    );
    mesh.position.set(
