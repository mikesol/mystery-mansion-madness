...
export const HIGHWAY_GEOMETRY = new three.BoxGeometry(HIGHWAY_SCALE_X, HIGHWAY_SCALE_Y, HIGHWAY_SCALE_Z);
export const HIGHWAY_MATERIAL = new three.MeshBasicMaterial({ color: 0x353436 });
...
export const JUDGE_POSITION_X = 0.000;
export const JUDGE_POSITION_Y = 0.003;
export const JUDGE_POSITION_Z = 0.000;
export const JUDGE_GEOMETRY = new three.BoxGeometry(JUDGE_SCALE_X, JUDGE_SCALE_Y, JUDGE_SCALE_Z);
...
export const RAIL_GEOMETRY = new three.BoxGeometry(RAIL_SCALE_X, RAIL_SCALE_Y, RAIL_SCALE_Z);
...
export const createRails = () => {
    ...
    leftRailMatrix.makeRotationFromEuler(new three.Euler(0.0, 0.0, -RAIL_ROTATION));
    rightRailMatrix.makeRotationFromEuler(new three.Euler(0.0, 0.0, RAIL_ROTATION));
    leftRailMatrix.setPosition(new three.Vector3(-HIGHWAY_SCALE_X / 2 - RAIL_OFFSET, RAIL_OFFSET, RAIL_POSITION_Z));
    rightRailMatrix.setPosition(new three.Vector3(HIGHWAY_SCALE_X / 2 + RAIL_OFFSET, RAIL_OFFSET, RAIL_POSITION_Z));
...
export const RAIL_JUDGE_GEOMETRY = new three.BoxGeometry(RAIL_SCALE_X, JUDGE_SCALE_Y, JUDGE_SCALE_Z);
export const RAIL_JUDGE_MATERIAL = new three.MeshBasicMaterial({ color: 0xFFFFFF });

export const createRailJudge = () => {
    const mesh = new three.InstancedMesh(RAIL_JUDGE_GEOMETRY, RAIL_JUDGE_MATERIAL, 2);

    const leftRailJudgeMatrix = new three.Matrix4();
    const rightRailJudgeMatrix = new three.Matrix4();

    leftRailJudgeMatrix.makeRotationFromEuler(new three.Euler(0.0, 0.0, -RAIL_ROTATION));
    rightRailJudgeMatrix.makeRotationFromEuler(new three.Euler(0.0, 0.0, RAIL_ROTATION));

    leftRailJudgeMatrix.setPosition(new three.Vector3(-HIGHWAY_SCALE_X / 2 - RAIL_OFFSET + 0.003, RAIL_OFFSET + 0.003, JUDGE_POSITION_Z));
    rightRailJudgeMatrix.setPosition(new three.Vector3(HIGHWAY_SCALE_X / 2 + RAIL_OFFSET - 0.003, RAIL_OFFSET + 0.003, JUDGE_POSITION_Z));
...
export const LANE_DIM_GEOMETRY = new three.BoxGeometry(LANE_DIM_SCALE_X, LANE_DIM_SCALE_Y, LANE_DIM_SCALE_Z);
export const LANE_DIM_MATERIAL = new three.MeshBasicMaterial({ color: 0xFFFFFF, transparent: true, opacity: 0.2 });
...
export const RAIL_DIM_GEOMETRY = new three.BoxGeometry(RAIL_SCALE_X_BASE, RAIL_SCALE_Y, RAIL_SCALE_Z);
export const RAIL_DIM_MATERIAL = new three.MeshBasicMaterial({ color: 0xFFFFFF, transparent: true, opacity: 0.2 });
